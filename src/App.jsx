...
function MabelMini(props){
 ...
 return React.createElement("div",{style:{position:"fixed",bottom:16,left:280,width:open?360:200,zIndex:200,background:BG,border:"1px solid "+MABEL_C+"55",borderRadius:8,overflow:"hidden",transition:"width .2s"}},
...
function MapLegend(props){
  ...
  return React.createElement("div",{style:{position:"fixed",bottom:16,left:16,zIndex:20,
