...
function DiceRoller(props){
 ...
 return React.createElement("div",{style:{position:"fixed",bottom:35,right:24,width:268,background:BG,border:"1px solid "+B3,borderRadius:8,zIndex:100,overflow:"hidden"}},
...
function MabelMini(props){
 ...
 return React.createElement("div",{style:{position:"fixed",bottom:35,left:"calc(50vw - 156.5px)",transform:"translateX(-50%)",width:open?360:200,zIndex:200,transform:"translateX(-50%)",background:BG,border:"1px solid "+MABEL_C+"55",borderRadius:8,overflow:"hidden",transition:"width .2s"}},
...
function MapLegend(props){
  ...
  return React.createElement("div",{style:{position:"fixed",bottom:35,left:35,zIndex:20,
