...
if(window.__mabelSend){window.__mabelSend("the cybersphere just logged a d"+sides+" roll: result "+roll+". narrate the consequence in character as the hidden MABEL — terse, urgent, game-master voice. no rules text, just what happens.");}
