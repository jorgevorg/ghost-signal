...
function MabelMini(props){
 ...
 return React.createElement("div",{style:{position:"fixed",bottom:35,left:"calc(50vw - 29.5px)",width:open?360:200,zIndex:200,transform:"translateX(-50%)",background:BG,border:"1px solid "+MABEL_C+"55",borderRadius:8,overflow:"hidden",transition:"width .2s"}},
