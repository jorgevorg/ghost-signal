...
function HexMap(props){
  ...
  var openHex=function(hex,e){
    ...
    setSel([]);setCtx(null);
    var d=hexMap[hex.id]||{};
    setForm({name:d.name||"HEX-"+String(hex.id).padStart(3,"0"),type:d.type||"",notes:d.notes||"",ships:d.ships||[]});
 ...
 return React.createElement("div",{style:{height:"100vh",overflow:"hidden",background:BG,color:"#ddd",position:"relative",zIndex:1}},
  ...
  React.createElement("div",{style:{position:"relative",zIndex:2,maxWidth:1100,margin:"0 auto",padding:"0 16px 0",height:"100vh",display:"flex",flexDirection:"column",boxSizing:"border-box"}},
    React.createElement("div",{style:{display:"flex",gap:0,borderBottom:"1px solid #222230",marginBottom:0,position:"sticky",top:0,background:BG,zIndex:10,paddingTop:16}},
     gs.campaignMap&&React.createElement("div",{style:{position:"fixed",bottom:20,left:20,background:"#0a0a14dd",border:"1px solid #ffffff18",borderRadius:8,padding:"12px 16px",fontFamily:"'Share Tech Mono',monospace",color:"#aaaacc",fontSize:9,zIndex:20,maxWidth:260,pointerEvents:"none"}},React.createElement("div",{style:{color:"#ffffff88",fontSize:7,letterSpacing:2,marginBottom:4}},["OUTER RING","MID RING","INNER RING"][(gs.chapter||1)-1]+" — SYSTEM "+["I","II","III"][(gs.chapter||1)-1]),React.createElement("div",{style:{color:"#ffffffcc",fontSize:10,fontFamily:"'Orbitron',sans-serif",marginBottom:4}},gs.campaignMap.name),React.createElement("div",{style:{color:"#aaaacc",fontSize:8,lineHeight:"1.5"}},gs.campaignMap.desc)),gs.shipPopup&&SHIP_DATA[gs.shipPopup.ship]&&React.createElement("div",{onClick:function(){setGs(function(g){return Object.assign({},g,{shipPopup:null});});},style:{position:"fixed",top:gs.shipPopup.y+12,left:gs.shipPopup.x+12,background:"#0a0a14ee",border:"1px solid "+SHIP_DATA[gs.shipPopup.ship].color+"66",borderRadius:8,padding:"12px 16px",fontFamily:"'Share Tech Mono',monospace",zIndex:30,minWidth:180,cursor:"pointer"}},React.createElement("div",{style:{color:SHIP_DATA[gs.shipPopup.ship].color,fontSize:10,fontFamily:"'Orbitron',sans-serif",marginBottom:2}},SHIP_DATA[gs.shipPopup.ship].name),React.createElement("div",{style:{color:"#aaaacc",fontSize:8,marginBottom:6}},SHIP_DATA[gs.shipPopup.ship].cls+" • HULL "+SHIP_DATA[gs.shipPopup.ship].hull+" • ACT "+SHIP_DATA[gs.shipPopup.ship].act),React.createElement("div",{style:{height:1,background:"#ffffff18",margin:"4px 0 8px"}}),React.createElement("div",{style:{color:"#aaaacc",fontSize:8,lineHeight:"1.6"}},SHIP_DATA[gs.shipPopup.ship].skill),React.createElement("div",{style:{color:"#ffffff22",fontSize:7,marginTop:8,textAlign:"right"}},TABS.map(function(t){var a=tab===t;var tc=TAB_C[t];return React.createElement("button",{key:t,onClick:function(){setTab(t);},style:{flex:1,padding:"10px 0",background:a?tc+"14":"transparent",border:"none",borderBottom:a?"2px solid "+tc:"2px solid transparent",color:a?tc:"#556",fontFamily:MONO,fontSize:10,letterSpacing:2,cursor:"pointer",transition:"all .2s"}},t);})
    ),
