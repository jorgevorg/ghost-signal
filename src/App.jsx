...
function App(){
 ...
 return React.createElement("div",{style:{height:"100vh",overflow:"hidden",background:BG,color:"#ddd",position:"relative",zIndex:1}},
  ...
  React.createElement("div",{style:{position:"fixed",top:10,left:10,background:"red",color:"white",fontSize:20,zIndex:99999,padding:"20px"}},"OVERLAY TEST — map: "+(gs.campaignMap?gs.campaignMap.name:"NULL")),
