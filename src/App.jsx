...
function ResetRunButton(props){
  ...
  return React.createElement("div",{
    style:Object.assign({display:"flex",flexDirection:"column",alignItems:"center",gap:4},style)
  },
    flash?React.createElement("div",{
      style:{fontFamily:MONO,fontSize:9,color:"#00FFD0",letterSpacing:3,opacity:.9,animation:"dotBlink .3s ease-in-out 2"}
    },"SESSION FLUSHED"):null,
    React.createElement(CPButton,{
      color:"#00FFD0",
      width:160,
      label:"RESET RUN",
      onClick:handleClick,
      style:{opacity:flash?.6:1,transition:"opacity .15s"}
    })
  );
}
...
function ResetRunButton(props){
  ...
  return React.createElement("div",{style:Object.assign({display:"flex",flexDirection:"column",alignItems:"center",gap:3},style)},
    flash?React.createElement("div",{style:{fontFamily:"'Share Tech Mono',monospace",fontSize:9,color:"#00FFD0",letterSpacing:3,opacity:.9}},"SESSION FLUSHED"):null,
    React.createElement("button",{
      onClick:handleClick,
      style:{background:"transparent",border:"1px solid #00FFD0"+(flash?"ff":"55"),color:"#00FFD0"+(flash?"ff":"88"),fontFamily:"'Orbitron',sans-serif",fontSize:8,letterSpacing:2,padding:"3px 9px",cursor:"pointer",borderRadius:1,transition:"all .2s"}
    },"↺ RESET RUN")
  );
}
