...
setLogs(function(prev){return prev.map(function(e,ei){return ei===i?{t:e.t,s:e.s.replace(part,"d"+sides+" -> "+roll)}:e;}).concat([{t:"system",s:note},{t:"mabel",s:osMabelLine}]);});},style:{display:"inline-block",fontFamily:MONO,fontSize:"0.82em",letterSpacing:2,color:clr,border:"1px solid "+clr,borderRadius:2,padding:"1px 7px",margin:"0 3px",cursor:"pointer",verticalAlign:"middle",userSelect:"none",background:clr+"16"}},part);});})():[l.s]));}),
